...
contract MockDSCEngine is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (endingUserHealthFactor <= MIN_HEALTH_FACTOR) { // testMockLiquidateRevertsIfHealthFactorBroken() works fine even with DSCEngine's condition: endingUserHealthFactor <= startingUserHealthFactor.
